...
switch data_name
    ...
    case 'VOC2012'
        ...
        step = 1456; %364=1456/4
        data_root = 'path/to/VOCdataset';
        eval_list = 'list/VOC2012_test.txt';
        save_root = 'mc_result/VOC2012';
        model_weights = '';
        model_deploy = '';
        fea_cha = 21;
        base_size = 512;
    ...
    case 'cityscapes'
        isVal = true;
        step = 125; %125=500/4
        data_root = 'path/to/Cityscapesdataset';
        eval_list = 'list/cityscapes_test.txt';
        save_root = 'mc_result/Cityscapes';
        model_weights = '';
        model_deploy = 'prototxt/pspnet101_cityscapes_473_dcu_deploy.prototxt';
        fea_cha = 19;
        base_size = 2048;
        crop_size = 473;
...
mean_r = 122.68; %means to be subtracted and the given values are used in our training stage
mean_g = 116.779;
mean_b = 103.939;

acc = double.empty;
iou = double.empty;
gpu_id_array = [0,1,2,3]; %multi-GPUs for parfor testing, if number of GPUs is changed, remember to change the variable 'step'
runID = 1;
